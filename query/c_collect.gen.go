...
func newCollect(db *gorm.DB) collect {
	_collect := collect{}

	_collect.collectDo.UseDB(db)
	_collect.collectDo.UseModel(&model.Collect{})

	tableName := _collect.collectDo.TableName()
	_collect.ALL = field.NewField(tableName, "*")
	_collect.ID = field.NewInt64(tableName, "id")
	_collect.UserID = field.NewString(tableName, "user_id")
	_collect.SightID = field.NewString(tableName, "sight_id")
	_collect.SightImages = field.NewString(tableName, "sight_images")
	_collect.SightName = field.NewString(tableName, "sight_name")
	_collect.StarLevel = field.NewString(tableName, "star_level")
	_collect.RegionID = field.NewString(tableName, "region_id")
	_collect.CreateTime = field.NewTime(tableName, "create_time")
	_collect.UpdateTime = field.NewTime(tableName, "update_time")
...
func (c *collect) updateTableName(table string) *collect {
	...
	c.SightImages = field.NewString(table, "sight_images")
	c.SightName = field.NewString(table, "sight_name")
	c.StarLevel = field.NewString(table, "star_level")
...
func (c *collect) WithContext(ctx context.Context) *collectDo { return c.collectDo.WithContext(ctx) }
...
func (c *collect) fillFieldMap() {
	...
	c.fieldMap["sight_images"] = c.SightImages
	c.fieldMap["sight_name"] = c.SightName
	c.fieldMap["star_level"] = c.StarLevel
